...
dotsWrapper.style.setProperty('--dots-margin', "".concat(margin, "px"));
dotsWrapper.style.setProperty('--dots-size', "".concat(size, "px"));

for (var index = 0; index < dotsCount; index++) {
  var el = document.createElement('div');
  el.classList.add('dot');
  el.style.animationDelay = "".concat(index % 4 * .5, "s");
...
button.addEventListener('click', function () {
  Array.prototype.forEach.call(dotsList, function (el) {
